...
class ElectionBetListScreen extends StatefulWidget {
  const ElectionBetListScreen({super.key});

  @override
  State<ElectionBetListScreen> createState() => _ElectionBetListScreenState();
}

class _ElectionBetListScreenState extends State<ElectionBetListScreen> {
  ...
  Widget build(BuildContext context) {
    return Padding(
      ...
      child: Column(
        ...
        children: [
          Text("Election Book Maker List", style: TextStyle(fontSize: 30, fontWeight: FontWeight.bold)),
          Container(
          ...
          SizedBox(
            ...
            child: DataTable(
              ...
              columns: tennisBetlist.map((header) => DataColumn(label: Text(header))).toList(),
              rows: [],
            ),
          ),
        ],
