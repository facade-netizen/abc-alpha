...
class ElectionSettleScreen extends StatefulWidget {
  const ElectionSettleScreen({super.key});

  @override
  State<ElectionSettleScreen> createState() => _ElectionSettleScreenState();
}

class _ElectionSettleScreenState extends State<ElectionSettleScreen> {
  ...
  Widget build(BuildContext context) {
    return Padding(
      ...
      child: Column(
        ...
        children: [
          const Text("Fancy Bet Settle Market", style: TextStyle(fontSize: 30, fontWeight: FontWeight.bold)),
          Container(
          ...
          SizedBox(
            ...
            child: DataTable(
              ...
              columns: electionSettle.map((header) => DataColumn(label: Text(header))).toList(),
              rows: [],
            ),
          ),
        ],
